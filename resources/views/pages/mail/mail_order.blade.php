		...
		<div class="col-md-12" >
			...
			<div class="row" style="background: cadetblue;padding: 15px">
				...
				<div class="col-md-6" style="text-align: center;color: #fff;font-weight: bold;font-size: 30px">
					<h4 style="margin:0">SHOP GIÀY Q & A</h4>
				...
				<div class="col-md-12">
					<p style="color:#fff;font-size: 17px;">Bạn hoặc một ai đó đã đặt hàng tại shop với thông tin như sau:</p>
					...
					<table class="table table-striped" style="border:1px">
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="4" align="right">Tổng tiền thanh toán khi chưa áp dụng mã giảm giá: {{number_format($total,0,',','.')}} VND</td>
							</tr>
				...
				<p style="color:#fff">Mọi chi tiết xin quý khách hàng liên hệ qua số hotline: 0344872892.Xin cảm ơn quý khách đã đặt hàng shop chúng tôi.</p>
