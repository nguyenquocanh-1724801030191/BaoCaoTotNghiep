...
(function (e, undefined) {
        ...
        (function (e, undefined) {
            ...
            function kt(e, t, r, o) {
                ...
                if (!o && 1 === f.length) {
                    if (
                        ...
                        if (
                            ((t = (i.find.ID(l.matches[0].replace(nt, rt), t) ||
                                [])[0]),
                            !t)
                        )
                            return r;
            ...
            (n.sortStable = v.split("").sort(S).join("") === v),
                ...
                (n.sortDetached = ut(function (e) {
                    return (
                        1 & e.compareDocumentPosition(p.createElement("div"))
                    );
                })),
                ut(function (e) {
                    return (
                ...
                while (l--)
                    if (
                        ...
                        s &&
                            !f.length &&
                            ((p.teardown &&
                                p.teardown.call(e, d, m.handle) !== !1) ||
    ...
    x.fn.extend({
        ...
        is: function (e) {
            return !!et(
                this,
                "string" == typeof e && Q.test(e) ? x(e) : e || [],
                !1
            ).length;
        },
        ...
        function (e, t) {
            x.fn[e] = function (n, r) {
                ...
                return (
                    ...
                    this.length > 1 &&
                        (K[e] || x.unique(i), J.test(e) && i.reverse()),
                    this.pushStack(i)
                );
            };
        }
        ...
        x.fn.extend({
            ...
            domManip: function (e, t, n) {
                ...
                if (
                    ...
                    for (
                        o = x.map(mt(r, "script"), ft), s = o.length;
                        c > l;
                        l++
                    )
                        (a = r),
        ...
        return (
            n ||
                ...
                ("none" !== n && n) ||
                    ...
                    (t = (xt[0].contentWindow || xt[0].contentDocument)
                        .document),
        ...
        x(function () {
            x.support.reliableMarginRight ||
                (x.cssHooks.marginRight = {
                    get: function (e, t) {
                        return t
                            ? x.swap(e, { display: "inline-block" }, vt, [
                                  e,
                                  "marginRight",
                              ])
                            : undefined;
            ...
            return a || "jsonp" === t.dataTypes[0]
                ? ((i = t.jsonpCallback = x.isFunction(t.jsonpCallback)
                  ...
                  r.always(function () {
                      (e[i] = o),
                          t[i] &&
                              ((t.jsonpCallback = n.jsonpCallback), hn.push(i)),
